                            ...
                            <div class="items_group clearfix">
                                ...
                                <div class="column one column_column">
                                    <div class="column_attr align_center">
                                        ...
                                        <h3>
                                            Employers access best interns through A2B anytime of the year, 24/7 and 365 days a year.
                                            Interns get alerts when we find a matching opportunity for you.
                                        </h3>
                                        ...
                                        <a class="content_link " href="#"><span class="icon"><i class="icon-chart-area"></i></span><span class="title">Track</span></a>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="items_group clearfix">
                                ...
                                <div class="column one-third column_image">
                                    <div class="image_frame no_link scale-with-grid aligncenter no_border">
                                        <div class="image_wrapper"><img class="scale-with-grid" src="{{asset('university/images/lady.png')}}" alt="">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="column two-third column_column">
                                    <div class="column_attr ">
                                        <div class="column one">
                                            <h2>What can you expect during Internship under the Featured Program and beyond?</h2>
                                            <ul>
                                                <li>
                                                    You’ll learn about a company and its culture, the industry, and various job roles.
                                                </li>
                                                <li>
                                                    You’ll also develop new skills and make new connections that very well might provide professional references for you some day.
                                                </li>
                                                <li>
                                                    You’ll go through training, get feedback on your performance, and get career advice.
                                                </li>
                                                <li>
                                                    During your internship, you get the opportunity to build your communication skills and get familiar with common office software packages including Microsoft Word and Excel.
                                                </li>
                                            </ul>
                        ...
                        <div class="section_wrapper clearfix">
                            <div class="items_group clearfix">
                                ...
                                <div class="column one-fourth column_quick_fact">
                                    <!-- Counter area-->
                                    <div class="quick_fact animate-math">
                                        <div class="number" data-to="32">
                                            32
                                        </div>
                                        <h3 class="title">Hours </h3>
                                        <hr class="hr_narrow" />
                                        <div class="desc">
                                            You should commit minimum of 32 hours per week for work at host organization                                        </div>
                                    </div>
                                </div>
                            </div>
                        </div>
