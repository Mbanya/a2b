@extends('layout.sub')
@section('assets')
    <title>Special Programs  Internships</title>
    @endsection
@section('header')
    @endsection
@section('content')
                            ...
                            <div class="items_group clearfix">
                                ...
                                <div class="column one-third column_image">
                                    <div class="image_frame no_link scale-with-grid aligncenter no_border">
                                        <div class="image_wrapper"><img class="scale-with-grid" src="{{asset('university/images/doctor.png')}}" alt="">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="column two-third column_column">
                                    <div class="column_attr ">
                                        ...
                                        <div class="column one">
                                            ...
                                            <p class="big">
                                                ­	You’ll learn about the employing organization and its programs and projects, the industry, and various job roles.
                                                ­	You’ll also develop new skills and make new connections that very well might provide critical professional references for you some day.
                                            </p>
                                            <p>
